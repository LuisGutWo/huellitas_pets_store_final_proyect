          ...
          <CardGroup className="blog-cards-group">
            <Card className="blog-card">
              ...
              <Card.Body className="blog-card-body">
                <Card.Title className="blog-card-title">Alimentos holísticos</Card.Title>
            ...
            <Card className="blog-card">
              ...
              />
              <Card.Body className="blog-card-body">
                <Card.Title className="blog-card-title">Dia mundial de los animales</Card.Title>
                <Card.Text className="blog-card-text">
        ...
        <Carousel.Item interval={4000}>
          <CardGroup className="blog-cards-group">
            <Card className="blog-card">
              ...
              />
              <Card.Body className="blog-card-body">
                <Card.Title className="blog-card-title">¿Se aburren de su alimento?</Card.Title>
                <Card.Text className="blog-card-text">
            ...
            <Card className="blog-card">
              ...
              />
              <Card.Body className="blog-card-body">
                <Card.Title className="blog-card-title">Tu perro y las altas temperaturas</Card.Title>
                <Card.Text className="blog-card-text">
        ...
        <Carousel.Item interval={4000}>
          <CardGroup className="blog-cards-group">
            ...
            <Card className="blog-card">
              ...
              />
              <Card.Body className="blog-card-body">
                <Card.Title className="blog-card-title">Las Mascotas y el Invierno</Card.Title>
                <Card.Text className="blog-card-text">
        ...
        <Carousel.Item>
          <CardGroup className="blog-cards-group">
            <Card className="blog-card">
              ...
              />
              <Card.Body className="blog-card-body">
                <Card.Title className="blog-card-title">Cuidados básicos de tu mascota</Card.Title>
                <Card.Text className="blog-card-text">
            ...
            <Card className="blog-card">
              ...
              />
              <Card.Body className="blog-card-body">
                <Card.Title className="blog-card-title">El Vinculo afectivo con los animales</Card.Title>
                <Card.Text className="blog-card-text">

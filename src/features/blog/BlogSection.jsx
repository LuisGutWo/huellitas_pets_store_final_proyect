              ...
              <Card className="blog-card">
                ...
                <Card.Body className="blog-card-body">
                  ...
                  <Card.Text className="blog-card-text">
                    ...
                    elaboración de alimentos de alta gama comenzaron en 1982, y
                    en la actualidad, el mercado de alimentos para mascotas
                    domesticas se ha...
                  </Card.Text>
                </Card.Body>
              </Card>
              <Card className="blog-card">
                ...
                <Card.Body className="blog-card-body">
                  ...
                  <Card.Text className="blog-card-text">
                    ...
                    animales en conmemoración de San Francisco de Asís. Este
                    santo que nació en 1182 en Italia y dejo...
                  </Card.Text>
                </Card.Body>
              </Card>
            </CardGroup>
          ...
          <Carousel.Item interval={4000}>
            <CardGroup className="blog-cards-group">
              <Card className="blog-card">
                ...
                <Card.Body className="blog-card-body">
                  <Card.Title className="blog-card-title">
                    ¿Se aburren de su alimento?
                  </Card.Title>
                  <Card.Text className="blog-card-text">
                    ¿Se aburrirá nuestra mascota si lo alimentamos siempre con
                    la misma dieta? La respuesta es no. El aburrimiento hacia
                    los alimentos es una característica humana. Los perros y
                    los...
                  </Card.Text>
                </Card.Body>
              </Card>
              <Card className="blog-card">
                ...
                <Card.Body className="blog-card-body">
                  <Card.Title className="blog-card-title">
                    Tu perro y las altas temperaturas
                  </Card.Title>
                  <Card.Text className="blog-card-text">
                    El verano es una gran época para disfrutar de sol, el calor
                    y refrescarse en las piletas y playas. Pero los perros, al
                    igual que las personas, pueden sufrir con las altas
                    temperaturas e...
                  </Card.Text>
                </Card.Body>
              </Card>
          ...
          <Carousel.Item>
            <CardGroup className="blog-cards-group">
              <Card className="blog-card">
                ...
                <Card.Body className="blog-card-body">
                  <Card.Title className="blog-card-title">
                    Cuidados básicos de tu mascota
                  </Card.Title>
                  <Card.Text className="blog-card-text">
                    ¡Hola Adoptantes novatos! Vamos a dar un repaso por los
                    puntos básicos a tener en cuenta para los cuidados de tu
                    animal de compañía. Si quieres ser muy responsable, sigues
                    estos consejos...
                  </Card.Text>
                </Card.Body>
              </Card>
              <Card className="blog-card">
                ...
                <Card.Body className="blog-card-body">
                  <Card.Title className="blog-card-title">
                    El Vinculo afectivo con los animales
                  </Card.Title>
                  <Card.Text className="blog-card-text">
